...
- Before `/claude-flow:feature-plan-creator` — to refine vague requirements into concrete specs
...
Output a **Design Brief** that can be directly fed to `/claude-flow:feature-plan-creator`.
